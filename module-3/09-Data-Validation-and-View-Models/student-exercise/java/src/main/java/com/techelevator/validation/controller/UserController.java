...
public class UserController {
	...
	public String getRegister(Model modelHolder) {
	...
	public String submitRegistrationForm(@Valid @ModelAttribute("registration") Registration
			registerFormValues, BindingResult result,
	...
	public String getLogin(Model modelHolder) {
	...
	public String showLogin(@Valid @ModelAttribute("login") Login
			loginFormValues, BindingResult result,
			RedirectAttributes flash) {
