...
SELECT name, region
FROM country
WHERE continent = 'North America' OR region = 'South America';
...
SELECT name
FROM city
WHERE population BETWEEN 1000000 AND 2000000 AND countrycode = 'USA';
...
SELECT (2020 - indepyear) AS YearsSinceIndep
FROM country
