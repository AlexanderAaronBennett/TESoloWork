...
-- (19 rows)
        ...
        FROM city
        WHERE district = 'Pennsylvania' OR district = 'West Virginina' OR district = 'Kentucky' OR district = 'Indiana' OR district = 'Michigan'
...
SELECT name, gnpold, gnp, ABS(gnpold - gnp) AS gnp_dif
from country
...
SELECT COUNT(name) AS name_count, continent
FROM country
GROUP BY continent
