...
public class Exercises {
	...
	/*
	 * 1 Given a string name, e.g. "Bob", return a greeting of the form
	...
	/*
	 * 2 Given two strings, a and b, return the result of putting them together in
	...
	/*
	 * 3 The web is built with HTML strings like "<i>Yay</i>" which draws Yay as
	...
	/*
	 * 4 Given an "out" string length 4, such as "<<>>", and a word, return a new
	...
	/*
	 * 5 Given a string, return a new string made of 3 copies of the last 2 chars of
	...
	/*
	 * 6 Given a string, return the string made of its first two chars, so the
	...
	/*
	 * 7 Given a string of even length, return the first half. So the string
	 * "WooHoo" yields "Woo". firstHalf("WooHoo") → "Woo" firstHalf("HelloThere") →
	...
	/*
	 * 8 Given a string, return a version without the first and last char, so
	...
	/*
	 * 9 Given 2 strings, a and b, return a string of the form short+long+short,
	...
	/*
	 * 10 Given 2 strings, return their concatenation, except omit the first char of
	...
	/*
	 * 11 Given a string, return a "rotated left 2" version where the first 2 chars
	 * are moved to the end. The string length will be at least 2. left2("Hello") →
	...
	/*
	 * 12 Given a string, return a "rotated right 2" version where the last 2 chars
	 * are moved to the start. The string length will be at least 2. right2("Hello")
	...
	/*
	 * 13 Given a string, return a string length 1 from its front, unless front is
	...
	/*
	 * 14 Given a string, return a version without both the first and last char of
	 * the string. The string may be any length, including 0. withoutEnd2("Hello") →
	...
	/*
	 * 15 Given a string of even length, return a string made of the middle two
	 * chars, so the string "string" yields "ri". The string length will be at least
	 * 2. middleTwo("string") → "ri" middleTwo("code") → "od" middleTwo("Practice")
	 * → "ct"
	 */
	...
	/*
	 * 16 Given a string, return true if it ends in "ly". endsLy("oddly") → true
	...
	/*
	 * 17 Given a string and an int n, return a string made of the first and last n
	...
	/*
	 * 18 Given a string and an index, return a string length 2 starting at the
	...
	/*
	 * 19 Given a string of odd length, return the string length 3 from its middle,
	...
	/*
	 * 20 Given a string, return true if "bad" appears starting at index 0 or 1 in
	...
	/*
	 * 21 Given a string and a non-negative int n, return a larger string that is n
	...
	public String frontTimes(String str, int n) {
		...
		if (str.length() > 3) {
			for (int i = 0; i < n; i++) {
				stringSum = stringSum + str.substring(0, 3);
			}

			return stringSum;
		}
		for (int i = 0; i < n; i++) {
			stringSum = stringSum + str.substring(0);
		}
		return stringSum;
	}
